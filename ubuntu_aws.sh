...
su - ubuntu -c "./npm.sh"
su - ubuntu -c "cd /home/ubuntu/stressgrid/coordinator/;yes |MIX_ENV=prod mix deps.get"
su - ubuntu -c "cd /home/ubuntu/stressgrid/coordinator/;yes |MIX_ENV=prod mix release"
su - ubuntu -c "cd /home/ubuntu/stressgrid/generator/;yes |MIX_ENV=prod mix deps.get"
su - ubuntu -c "cd /home/ubuntu/stressgrid/generator/;yes |MIX_ENV=prod mix release"
